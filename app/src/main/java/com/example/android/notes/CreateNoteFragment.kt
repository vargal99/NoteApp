...
import com.example.android.notes.entities.Notes
import com.example.android.notes.util.NoteBottomSheetFragment
...
class CreateNoteFragment : BaseFragment(), EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"Url kötelező!", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            Toast.makeText(context,"Cím kötetelő!", Toast.LENGTH_SHORT).show()
        }
        else if (etNoteSubTitle.text.isNullOrEmpty()){

            Toast.makeText(context,"Alcím kötelező!", Toast.LENGTH_SHORT).show()
        }

        else if (etNoteDesc.text.isNullOrEmpty()){

            Toast.makeText(context,"Jegyzet leírás kötelező!", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun checkWebUrl(){
        if (Patterns.WEB_URL.matcher(etWebLink.text.toString()).matches()){
            ...
            Toast.makeText(requireContext(),"Url nem létezik", Toast.LENGTH_SHORT).show()
        }
    }
